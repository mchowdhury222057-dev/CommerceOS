...
// through this app's own dark-mode-aware tokens (text-status-success etc.)
// instead of StatusBadge's hardcoded per-tone hex, which doesn't adapt to
// dark mode. Same tone vocabulary, so nothing using StatusBadge elsewhere
// (Admin Panel) needs to change.
