...
export function RiskBadge({ level }: { level: RiskLevel }) {
  ...
  if (level === "CAUTION") {
    return (
      <span className="inline-flex items-center gap-1 rounded-full bg-status-caution/10 px-2.5 py-1 text-xs font-medium text-[#92400E]">
  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-full bg-status-danger/10 px-2.5 py-1 text-xs font-medium text-[#991B1B]">
